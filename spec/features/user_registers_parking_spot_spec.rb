...
feature "user registers spot", %Q{
  ...
  #* I must enter a valid parking spot number (the lot has spots identified as nubers 1-60)
  #* I must enter a vaid email
  ...
  scenario 'attempts to register a spot that is taken' do
